...
import weddingImg1 from "../Images/Wedding1.png"
import weddingImg2 from "../Images/Wedding2.png"
import weddingImg3 from "../Images/Wedding3.png"
...
const Details = () => {
  const cardData = [
    ...
    },
    {
      id: 2,
      title: "Card  2",
      text: "This Coustomized Crad is only for Rs-70 per Card For More details contact us ",
      imgSrc: weddingImg2,
      link: "#",
    },
    {
      id: 2,
      title: "Card  2",
      text: "This Coustomized Crad is only for Rs-80 per Card For More details contact us ",
      imgSrc: weddingImg3,
      link: "#",
    },
  ...
  return (
    ...
    <div>
      ...
      <div className="weading">
        <h3 className="style"> WEADING PAKEGES</h3>
        <p>
          𝘦𝘭𝘭𝘦𝘢𝘦𝘷𝘦𝘯𝘵𝘴 𝘰𝘧𝘧𝘦𝘳𝘴 𝘢 𝘷𝘢𝘳𝘪𝘦𝘵𝘺 𝘰𝘧 𝘱𝘢𝘤𝘬𝘢𝘨𝘦𝘴 𝘵𝘰 𝘮𝘦𝘦𝘵 𝘺𝘰𝘶𝘳 𝘴𝘱𝘦𝘤𝘪𝘧𝘪𝘤 𝘸𝘦𝘥𝘥𝘪𝘯𝘨
          𝘱𝘭𝘢𝘯𝘯𝘪𝘯𝘨 𝘯𝘦𝘦𝘥𝘴. 𝘞𝘩𝘪𝘭𝘦 𝘵𝘩𝘦 𝘱𝘢𝘤𝘬𝘢𝘨𝘦𝘴 𝘳𝘢𝘯𝘨𝘦 𝘪𝘯 𝘴𝘦𝘳𝘷𝘪𝘤𝘦𝘴 𝘰𝘧𝘧𝘦𝘳𝘦𝘥, 𝘦𝘢𝘤𝘩
          𝘪𝘯𝘤𝘭𝘶𝘥𝘦𝘴 𝘤𝘰𝘯𝘴𝘶𝘭𝘵𝘪𝘯𝘨 𝘸𝘪𝘵𝘩 𝘢 𝘵𝘦𝘢𝘮 𝘰𝘧 𝘦𝘹𝘱𝘦𝘳𝘵𝘴 𝘸𝘩𝘰 𝘩𝘢𝘷𝘦 𝘦𝘹𝘱𝘦𝘳𝘪𝘦𝘯𝘤𝘦 𝘪𝘯
          𝘸𝘦𝘥𝘥𝘪𝘯𝘨 𝘱𝘭𝘢𝘯𝘯𝘪𝘯𝘨. 𝘐𝘧 𝘵𝘩𝘦𝘳𝘦 𝘪𝘴 𝘢 𝘱𝘢𝘤𝘬𝘢𝘨𝘦 𝘵𝘩𝘢𝘵 𝘥𝘰𝘦𝘴𝘯'𝘵 𝘲𝘶𝘪𝘵𝘦 𝘧𝘪𝘵 𝘸𝘩𝘢𝘵
          𝘺𝘰𝘶'𝘳𝘦 𝘭𝘰𝘰𝘬𝘪𝘯𝘨 𝘧𝘰𝘳, 𝘱𝘭𝘦𝘢𝘴𝘦 𝘤𝘰𝘯𝘵𝘢𝘤𝘵 𝘶𝘴 𝘧𝘰𝘳 𝘪𝘯𝘥𝘪𝘷𝘪𝘥𝘶𝘢𝘭𝘪𝘻𝘦𝘥 𝘰𝘱𝘵𝘪𝘰𝘯𝘴.
        </p>
        ...
        <p>
          ...
          wedding day finally arrives. Your “day of coordinator” will help make
        ...
        <h3> Here ar the Sample cards That we provide for Weiddings</h3>
